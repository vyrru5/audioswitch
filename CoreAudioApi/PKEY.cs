...
namespace AudioSwitch.CoreAudioApi
{
    public static class PKEY 
    {
        ...
        public static readonly PropertyKey PKEY_DeviceClass_IconPath = new PropertyKey { fmtid = new Guid(0x259abffc, 0x50a7, 0x47ce, 0xaf, 0x8, 0x68, 0xc9, 0xa7, 0xd7, 0x33, 0x66), pid = 12 };
